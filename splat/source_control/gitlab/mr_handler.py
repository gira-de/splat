...
class MergeRequestHandler:
    ...
    def get_open_merge_request(self, project: RemoteProject, branch_name: str) -> GitLabMergeRequestEntry | None:
    ...
    def update_existing_merge_request(
        ...
        updated_description = self.descr_generator.generate_full_descr(commit_messages, remaining_vulns)
    ...
    def create_new_merge_request(
        ...
        mr_description = self.descr_generator.generate_full_descr(commit_messages, remaining_vulns)
        mr_data: JSON = {
