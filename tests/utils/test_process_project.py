...
class TestProcessProjectIntegration(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.mock_env_manager.set("CI_JOB_URL", "")
        self.mock_env_manager.set("GITHUB_SERVER_URL", "")
        self.mock_env_manager.set("GITHUB_REPOSITORY", "")
        self.mock_env_manager.set("GITHUB_RUN_ID", "")
